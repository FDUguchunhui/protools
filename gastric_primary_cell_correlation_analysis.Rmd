...
gastric_count <- read_csv('data/gastric_primary_cell/gastric_primary_cell_count.csv')
...
RP_counts <-  gastric_count %>% filter(!(accession %in% P1_5_proteins_accession))
