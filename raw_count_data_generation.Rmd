...
## export data
```{r}
write_to_csv(gastric_primary_cell_count_mat, 'data/gastric_primary_cell/gastric_primary_cell_count.csv')
write_to_csv(gastric_primary_cell_nsaf_mat, 'data/gastric_primary_cell/gastric_primary_cell_nsaf.csv')
```
...
gastric_primary_cell_nsaf_mat <- nsaf(gastric_primary_cell_count_mat, protein_length_df, per_count = 10e6, na_fill=0)
gastric_primary_cell_nsaf_mat <- gastric_primary_cell_nsaf_mat[rowSums(gastric_primary_cell_nsaf_mat > 0) > 0, ]
write_to_csv(gastric_primary_cell_count_mat, 'data/gastric_primary_cell/gastric_primary_cell_count_2.csv')
write_to_csv(gastric_primary_cell_nsaf_mat, 'data/gastric_primary_cell/gastric_primary_cell_nsaf_2.csv')
```
